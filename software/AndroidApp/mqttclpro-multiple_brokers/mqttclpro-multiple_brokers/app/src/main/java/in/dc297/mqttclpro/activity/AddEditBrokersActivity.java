...
*/
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            getActivity().findViewById(R.id.save);
           // getActivity().getMenuInflater().inflate(R.menu.menu_add_edit_brokers, optionsMenu);
            //this.onOptionsItemSelected(optionsMenu.findItem(R.id.save));
        }
